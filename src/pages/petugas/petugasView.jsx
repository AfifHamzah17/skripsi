    ...
    return (
      <div style={{position:'fixed',inset:0,zIndex:9999,display:'flex',alignItems:'center',justifyContent:'center',padding:16}}>
        ...
        <div style={{position:'relative',backgroundColor:'#fff',borderRadius:16,boxShadow:'0 25px 50px rgba(0,0,0,0.2)',width:'100%',maxWidth:520,maxHeight:'90vh',overflow:'hidden',display:'flex',flexDirection:'column'}}>
          ...
          <div style={{flex:1,overflowY:'auto',padding:'20px 24px',display:'flex',flexDirection:'column',gap:20}}>
            ...
            <div>{sec(<FaUser style={{fontSize:12,color:'#3b82f6'}}/>,'Info Peminjam')}
              <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
                <div style={{width:48,height:48,borderRadius:14,backgroundColor:'#eff6ff',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,border:'2px solid #dbeafe',overflow:'hidden'}}>{u?.foto?<img src={u.foto} alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/>:<FaUser style={{fontSize:20,color:'#93c5fd'}}/>}</div>
            ...
            <div>{sec(<FaUserCircle style={{fontSize:12,color:'#8b5cf6'}}/>,'Guru Pendamping')}
              <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
                <div style={{width:48,height:48,borderRadius:14,backgroundColor:'#faf5ff',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,border:'2px solid #e9d5ff',overflow:'hidden'}}>{g?.foto?<img src={g.foto} alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/>:<FaUserCircle style={{fontSize:20,color:'#c084fc'}}/>}</div>
          ...
          <div style={{padding:'16px 24px',borderTop:'1px solid #f3f4f6',display:'flex',justifyContent:'flex-end',flexShrink:0}}><button type="button" onClick={onClose} style={{padding:'10px 24px',backgroundColor:'#f3f4f6',color:'#4b5563',fontWeight:600,borderRadius:10,border:'none',cursor:'pointer',fontSize:13}} onMouseEnter={(e)=>e.currentTarget.style.backgroundColor='#e5e7eb'} onMouseLeave={(e)=>e.currentTarget.style.backgroundColor='#f3f4f6'}>Tutup</button></div>
        </div>
      </div>
    );
  };
...
export default function PetugasView({
  ...
  detailModal, setDetailModal, handleViewDetail,
}) {
